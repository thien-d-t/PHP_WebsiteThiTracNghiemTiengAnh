...
<div class="row">
    <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="search_acc">
            ...
            <button class="add_acc">Thêm tài khoản</button>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "danhsach_taikhoan.php",
            type: "GET",
            success: function(data) {
                $(".danhsachdethi").html(data);
            },
            error: function(xhr, status, error) {
                $(".danhsachdethi").html('<p class="attention">Không thể tải danh sách tài khoản. Vui lòng thử lại sau.</p>');
            }
        });
        ...
        $('.add_acc').click(function() {
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    $("#add-account-form").html('<p class="attention">Không thể tải biểu mẫu thêm tài khoản. Vui lòng thử lại sau.</p>');
                }
            });
        });
    });
